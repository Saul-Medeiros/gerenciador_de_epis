    ...
    <body>
        <div class="main-container d-flex">
            ...
            <div id="conteudo" class="bg-background">
                ...
                <div class="container">
                    <form action="gerenciarEpi" method="post">
                        <h3 class="text-center">Cadastro de Epi</h3>
                        <input type="hidden" name="idEpi"
                               value="${epi.idEpi}">
                        ...
                        <div class="form-group row offset-md-2">
                            ...
                            <div class="col-md-5">
                                <select class="form-control-sm" name="status">
                                    ...
                                    <option value="1"
                                        <c:if test="${epi.status == 1}">
                                        selected</c:if>>
                                        Ativado
                                    </option>
                                    <option value="0"
                                        <c:if test="${epi.status == 0}">
                                        selected</c:if>>
                                        Desativado
                                    </option>
                                </select>
                            ...
                            <div class="d-md-flex justify-content-md-end mt-5">
                                ...
                                <a href="gerenciarEpi?acao=listar"
