                ...
                <div class="container">
                    <form action="gerenciarFuncionario" method="post">
                        ...
                        <div class="form-group row mt-5 offset-md-2">
                            ...
                            <div class="col-md-5">
                                <select class="form-control-sm" name="idCargo">
                                    <option value="">Escolha uma opção</option>
                                    <jsp:useBean class="dao.CargoDAO" id="cargoDAO"/>
                                    <c:forEach items="${cargoDAO.lista}" var="c">
                                        <option value="${c.idCargo}"
                                        <c:if test="${c.idCargo == funcionario.cargo.idCargo}">
                                        selected</c:if>>
                                            ${c.nome}
                                        </option>
                                    </c:forEach>
                        ...
                        <div class="form-group row mt-5 offset-md-2">
                            <label class="col-md-3">Setor</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row offset-md-2">
                            ...
                            <div class="d-md-flex justify-content-md-end mt-5">
                                ...
                                <a href="gerenciarFuncionario?acao=listar"
