    ...
    <body>
            ...
            <div id="conteudo" class="bg-background">
                ...
                <div class="container">
                    ...
                    <a href="cadastrarFuncionario.jsp"
                      ...
                      </svg> Cadastrar Funcionário
                    </a>
                    <table class="table table-hover table-striped"
                           id="listarFuncionarios">
                        <thead>
                            <tr>
                                <th>Código</th>
                                <th>Nome</th>
                        ...
                        <tbody>
                            <c:forEach items= "${funcionarios}" var="f">
                                <tr>
                                    ...
                                    <td>
                                        <a href="gerenciarFuncionario?acao=alterar&idFuncionario=${f.idFuncionario}"
                                        ...
                                        <c:choose>
                                            <c:when test="${f.status == 1}">
                                                <button class="btn btn-danger btn-sm" 
                                                    onclick="confirmDesativar('${f.idFuncionario}', '${f.nome}')">
                                                    <i class="bi bi-person-x-fill"></i> Desativar
                                                </button>
                                            </c:when>
                                            <c:otherwise>
                                                <button class="btn btn-success btn-sm"
                                                        onclick="confirmAtivar('${f.idFuncionario}', '${f.nome}')">
        ...
        <script type="text/javascript">
            function confirmDesativar(id, nome) {
                if(confirm('Deseja desativar o funcionário ' + nome + ' ?')){
                   location.href=
                           "gerenciarFuncionario?acao=desativar&idFuncionario=" + id;
                }
            }
            
            function confirmAtivar(id, nome) {
                if(confirm('Deseja ativar o funcionário ' + nome + ' ?')){
                   location.href=
                           "gerenciarFuncionario?acao=ativar&idFuncionario=" + id;
                }
            }
        </script>
